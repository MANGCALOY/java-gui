...
public class SignUpForm extends JFrame implements ActionListener {
    ...
    public SignUpForm() {
        ...
        fieldFullname.setForeground(new Color(0, 102, 0));
        ...
        fieldEmail.setForeground(new Color(0, 102, 0));
        ...
        fieldConfirmPassword.setForeground(new Color(0, 102, 0));
        ...
        buttonLogin.setBounds(335, 420, 70, 30);
        ...
        labelFooter.setBounds(200, 420, 300, 30);
